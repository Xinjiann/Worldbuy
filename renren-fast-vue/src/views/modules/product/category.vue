  ...
  <div>
    ...
    >
      <span class="custom-tree-node" slot-scope="{ node, data }">
        ...
        <span>
          <el-button v-if="node.level <=2" type="text" size="mini" @click="() => append(data)">add</el-button>
...
export default {
  ...
  methods: {
    ...
    batchDelete() {
      ...
      this.$confirm(`are you sure to delete{${catIds}} menu?`, "warning", {
    ...
    remove(node, data) {
      var ids = [data.catId];
      this.$confirm(`are you sure to delete【${data.name}】menu?`, "warning", {
        confirmButtonText: "yes",
        cancelButtonText: "no",
        type: "warning"
      })
