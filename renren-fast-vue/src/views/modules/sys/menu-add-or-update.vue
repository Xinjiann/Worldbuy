<template>
  <el-dialog
    ...
    <el-form :model="dataForm" :rules="dataRule" ref="dataForm" @keyup.enter.native="dataFormSubmit()" label-width="80px">
      ...
      <el-form-item v-if="dataForm.type !== 0" label="status" prop="perms">
        <el-input v-model="dataForm.perms" placeholder="multiple separated by commas, like: user:list,user:create"></el-input>
      </el-form-item>
      <el-form-item v-if="dataForm.type !== 2" label="index" prop="orderNum">
        <el-input-number v-model="dataForm.orderNum" controls-position="right" :min="0" label="index number"></el-input-number>
      </el-form-item>
