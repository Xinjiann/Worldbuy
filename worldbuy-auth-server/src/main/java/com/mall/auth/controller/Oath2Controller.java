...
public class Oath2Controller {
	...
	public String login(HttpSession session){
		...
		session.invalidate();
		return "redirect:http://auth.worldbuy.com/login.html";
	}
	...
	public String weiBo(@RequestParam("code") String code, HttpSession session) throws Exception {
		...
		map.put("redirect_uri", "http://auth.worldbuy.com/oauth2.0/weibo/success");
		map.put("code", code);
...
//				new Cookie("JSESSIONID","").setDomain("worldbuy.com");
